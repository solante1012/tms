...
public class TranslateController extends BaseController {
	...
	public RespBody save(@RequestParam("projectId") Long projectId,
		...
		try {
			mailSender.sendHtmlByQueue(String.format("DCST-翻译新建_%s", DateUtil.format(new Date(), DateUtil.FORMAT7)),
	...
	public RespBody update(@RequestParam("id") Long id,
		...
		if (translateItem != null) {
			...
			try {
				mailSender.sendHtmlByQueue(String.format("DCST-翻译更新_%s", DateUtil.format(new Date(), DateUtil.FORMAT7)),
	...
	public RespBody delete(@RequestParam("id") Long id,
		...
		try {
			mailSender.sendHtmlByQueue(String.format("DCST-翻译删除_%s", DateUtil.format(new Date(), DateUtil.FORMAT7)),
